var ddsitelogo={
	...
	logoHTML: '<a href="../pages/main.html" title="Dynamic Drive"><img src="../img/sswhitestroke" style="width:50px; height:47px; border:0" /></a>', //HTML for logo, which is auto wrapped in DIV w/ ID="mysitelogo"
